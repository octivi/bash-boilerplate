...
- **Breaking:** Rename updater command from `update-octivi-bash-boilerplate` to `octivi-bash-boilerplate-update` and align update/install paths for distributed artifacts ([`743c2c5`](https://github.com/octivi/bash-boilerplate/commit/743c2c5)) (Marcin Engelmann)
